...
remove = c('anchovies','herring', 'mackerel','salmon','salmonidae','sardines','shrimp','tuna') # vector with groups to be removed
...
# spp to remove
remove = c('anchovies','mackerel','salmon','salmonidae','sardines','shrimp','tuna') #vector with groups to be removed
...
# save data 
#write.csv(volatility_duration_stocks, "~/Documents/SESYNC/Files/FISHMAR-data/rq2/final_push/data/RQ2_data_covariates_1212.csv")
