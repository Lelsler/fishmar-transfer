...
data = read.csv("/Users/mtn1/Desktop/R_projects/fishmar/data/fao_stock_status/processed/1950_2017_FAO_bbmsy_timeseries_merge.csv")
#load Comtrade data
...
data = data %>% filter(comm_name == "Patagonian toothfish")
data$Year = data$year
...
boxplot(tryout$geff.Importer ~ tryout$Year)
